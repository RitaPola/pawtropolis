...
public class MapCreator {
    ...
    private static Room createMap() {
        ...
        MapController.linkRooms(entrance, kitchen, Direction.NORTH);
        kitchen.addItemInTheRoom(new Item("banana", "food", 1));
        kitchen.addItemInTheRoom(new Item("aqua", "water", 1));
        Room armory = new Room("Armory");
        MapController.linkRooms(kitchen, armory, Direction.SOUTH);
        ...
        MapController.linkRooms(armory,noursey, Direction.WEST);
